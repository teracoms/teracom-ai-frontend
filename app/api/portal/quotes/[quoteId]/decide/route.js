...
export async function POST(request, { params }) {
  ...
  try {
    const data = await decideQuote(token, params.quoteId, parsed.decision, parsed.notes);
    ...
    return NextResponse.json({ error: 'Unexpected error deciding this quote.' }, { status: 500 });
  }
}
