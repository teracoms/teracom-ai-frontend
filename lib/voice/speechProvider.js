...
// moment nothing better is found, never worse than before. The one
// real limitation, documented rather than hidden: getVoices() returns
// an empty list on first call in some browsers until the async
// `voiceschanged` event fires once; this is a best-effort synchronous
// pick, not a guarantee, on that first call.
