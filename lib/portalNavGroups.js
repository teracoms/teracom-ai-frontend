...
export const NAV_ITEMS = [
  ...
  { kind: 'link', href: '/portal/people', label: 'People' },
  { kind: 'link', href: '/portal/conversations', label: 'Conversations' },
...
// plain links, no dropdown groups -- Home, People (renamed "Executive
// Team" once CUSTOMER_EXPERIENCE_REDESIGN_V3's own Executive Team step
// lands), Projects, Outputs, Protection.
