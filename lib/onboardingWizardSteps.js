...
// shape for walkthrough testing. Steps 1-4 are `available: true` --
...
// visual, branding), V3/Step 3 (executive role selection, the full
// four-tier hierarchy visual), and V4/Step 4 (worker creation/templates,
// Department + Executive Owner assignment). Steps 5-9 are shown, not
// hidden, so the framework's intended shape is visible and testable,
// but are deliberately non-interactive ("coming soon") -- their own
// content (knowledge setup, marketplace worker packs, etc.) remains
