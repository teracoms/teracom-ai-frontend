...
// shape for walkthrough testing. Steps 1 and 2 are `available: true` --
// Wizard Framework V1 (organisation details, logo, industry, business
// size) and Wizard Framework V2/Step 2 (department creation/edit,
// templates, structure visual, branding). Steps 3-9 are shown, not
// hidden, so the framework's intended shape is visible and testable, but
// are deliberately non-interactive ("coming soon") -- their own content
