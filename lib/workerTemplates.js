...
// docs/workforce/WORKER_CATALOGUE.md's fuller 22-role organisational
...
export const WORKER_TEMPLATES = [
  ...
  },
  {
    ...
    whyItExists: 'AUTONOMOUS_ORGANISATION_V1/AUTONOMOUS_EXECUTION_V1 seeded this role once real, sandboxed execution and verification existed for it to use — distinct from the pre-existing "Frontend Developer" template above, which is chat-advisory only. See docs/workforce/WEB_DEVELOPER_WORKER.md for the full role definition this template is grounded in.',
  ...
  },
  {
    ...
    whyItExists: 'Matches this platform\'s real execution pipeline (Developer/Web Developer -> QA handoff) to an actual, assignable worker role — without a QA-named worker, a handoff_role="QA" task has no one to route to. See docs/workforce/QA_WORKER.md for the full role definition.',
