...
test('parseDepartmentFunctionPayload accepts "sales"/"customer_success"/null and rejects anything else', () => {
  ...
  assert.equal(parseDepartmentFunctionPayload({ function: 'marketing' }).valid, false);
