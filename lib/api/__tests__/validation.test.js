...
test('parseProjectStatusPayload accepts "active"/"completed"/"blocked" and rejects anything else', () => {
...
test('parseAIProviderRoutingRulesPayload validates every rule and forces purpose to null', () => {
  ...
  assert.deepEqual(result, {
    valid: true,
    rules: [
      { purpose: null, priority: 1, provider: 'anthropic', model_name: 'claude' },
