...
// rule_type is one of exactly 4 known values (validated backend-side too,
...
export const GOVERNANCE_RULE_TYPES = ['governance', 'policy', 'standards', 'knowledge_assignment'];
...
export const KNOWLEDGE_DOCUMENT_TYPES = ['policy', 'pricing_reference', 'case_study', 'template', 'general'];
