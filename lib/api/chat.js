...
// `{response: str, sources: string[]}` (sources added
// TECHNICAL_SUPPORT_OS_MVP_V1 — the Knowledge titles that fed the answer,
// possibly empty) — it never returns that new session's id. There is
