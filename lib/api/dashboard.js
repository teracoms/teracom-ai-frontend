...
// CUSTOMER_ONBOARDING_WIZARD_V1.md Step 2 -- Wizard Framework V2 Branding
// Updates. Mirrors uploadOrganisationLogo exactly (the backend's own
// _upload_branding_asset helper backs both).
export async function uploadOrganisationFavicon(token, formData) {
  return backendFetch('/organisations/favicon', { method: 'POST', token, body: formData });
}
