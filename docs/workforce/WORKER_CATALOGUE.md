...
**Status:** Roster of 21 worker types approved by the project owner, 2026-08-15 (9 original + Marketing Manager Worker and Content Production Worker added 2026-08-15), 2026-08-17 (CFO, Head of Sales, Head of Operations, Head of Customer Success Workers added — the recommended Executive/Department Head roster's remaining four; CTO Worker and Marketing Manager Worker already covered "CTO" and "Head of Marketing"), same-day (Sales Manager Worker, Customer Success Manager Worker added — Phase 0 Package J's operational, "doer" counterparts to the advisory-only Head of Sales/Head of Customer Success Department Head personas), same-day (Video Producer Worker added — Phase 0 Package K's third pipeline tier, taking its brief from an approved Content Production Worker output rather than from Marketing Manager Worker directly), and same-day (Finance Manager, Cost Analyst, Licensing Analyst Workers added — Phase 0 Package M's three parallel operational personas under the previously purely-advisory CFO Worker). This is the commercial/functional catalogue definition — for the technical mechanism a "worker" runs on, see [[backend-status]] §Domain model. For how workers map to editions/seats, see [[product-editions]]. For the Department Head structural layer six of these roles are recommended for, see [[department-head-layer]] (Phase 0 Package I) — none of the six is auto-created or bootstrapped; an admin creates and assigns each one manually, exactly like any other worker/department in this catalogue.
